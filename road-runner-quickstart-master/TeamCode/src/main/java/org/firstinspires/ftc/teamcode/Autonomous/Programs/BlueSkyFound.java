...
@Autonomous(name = "Blue-SkystoneOn-0-Bridge")
public class BlueSkyFound extends AutoBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.followTrajectorySync(
                drive.trajectoryBuilder()
                        ...
                        .splineTo(new Pose2d(40, 36, Math.toRadians(180)))
                        .build()
        );
        ...
        drive.followTrajectorySync(
                drive.trajectoryBuilder()
                        ...
                        .splineTo(new Pose2d(52, 36, Math.toRadians(180)))
                        .build()
        );
